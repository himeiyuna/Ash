...
//レンダラーを作成して、初期化します。
void AshMain::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void AshMain::OnWindowSizeChanged()
{
